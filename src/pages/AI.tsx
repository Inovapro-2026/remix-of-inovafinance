...
export default function AI() {
  ...
  // Convert currency values in text to natural speech (e.g., "R$ 100,50" -> "cem reáis e cinquenta centavos")
  ...
  const processMessage = async (message: string) => {
    ...
    try {
      ...
      if (invokeError) {
        ...
        throw new Error('Erro ao conectar com a assistente. Verifique sua conexão.');
      }

      if (!data) {
        throw new Error('A assistente não retornou resposta.');
      }
          ...
          if (settings && settings.enabled && settings.whatsapp_number) {
            ...
            if (response.ok) {
              ...
              if (contentType && contentType.includes('application/json')) {
                ...
                if (result.success) {
                  speak(`Feito! Acabei de te mandar um WhatsApp com essa mensagem. Dá uma olhada lá quando puder! 😉`);
      ...
      toast.error('Assistente temporariamente instável', {
